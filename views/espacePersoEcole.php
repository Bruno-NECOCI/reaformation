        <main>
            ...
            <div class="container-espace-perso">
                ...
                <h2 class="h2">Bienvenue dans votre espace personel !</h2>
                ...
                <div class="section1">
                    ...
                    <div class="info card-options">
                        ...
                        <form action="" class="form">
                            ...
                            <input type="text" name="prenom" value="<?php echo $data->nom ?>">
                            <input type="text" name="nom_ecole" value="<?php echo $data->ecole ?>">
                            ...
                            <input type="text" name="uai" value="<?php echo $data->uai ?>">
                ...
                <div class="section2">
                    ...
                    <div class="rdv card-options">
                        ...
                        <form action="" id="inscription">
                            ...
                            <!-- <div class="date">  
                                <input type="date" id="rdv" name="rdv" class="form-input">
                            </div> -->
                            <div class="datepicker">

                                <input type="text" id="datepicker" class="form-input">
